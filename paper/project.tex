...
From table \ref{fig:statistics} we see that, loops have very different
charasteristics than nonexistent links. Loops happens much more often than
nonexistent links, and were much more likely to cause a failure in traceroute
record. On the other hand, most of the traceroute with nonexistent links still
get to the destination at last. This pointed out that, loop is always a threat
in a network, and should always be avoided.
